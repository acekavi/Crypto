// DIAGNOSTIC — is the D1-bias-alignment result a plateau or a fluke, and is
// it broad or concentrated?
...
async fn diag_bias_verify() {
    ...
    println!("\nDIAG ---- breakdown of bias_ema_period=50 (the requested default) ----");
